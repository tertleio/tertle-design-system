  ...
  return (
    <>
      <label
        htmlFor={id}
        className={`
          my-[1px] flex cursor-pointer rounded-lg border border-gray-100 bg-transparent p-3 font-secondary
         text-gray-600 checked:bg-primary-dark hover:bg-gray-100 hover:opacity-90 focus:outline-none
